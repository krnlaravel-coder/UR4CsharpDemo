    ...
    public partial class TempertureTag2ReadEPCForm : BaseForm
    {
        ...
        private void UpdataEPC(TempertureInfo info)
        {
            ...
            else
            {
                ...
                lvEPC.Items.Add(lv);
                epcList.Add(new EpcInfo(uhfinfo.Epc,uhfinfo.Tid ,int.Parse(count), DataConvert.HexStringToByteArray(uhfinfo.Epc), DataConvert.HexStringToByteArray(uhfinfo.Tid)));
